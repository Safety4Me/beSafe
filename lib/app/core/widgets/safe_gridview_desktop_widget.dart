...
class SafeGridViewDesktopWidget extends StatelessWidget {
  ...
  const SafeGridViewDesktopWidget(
      ...
      required this.showButtonContact,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Visibility(
            visible: showButtonGoals || showButtonContact,
            child: Expanded(
              flex: 2,
          ...
          Expanded(
            ...
            child: Row(
              children: [
                ...
                Visibility(
                  visible:
                      (buttonContact != null && showButtonGoals) ? true : false,
                  child: Expanded(
                ...
                Visibility(
                  visible: showRadio,
                  child: Expanded(flex: 1, child: buttonRadio),
                ),
                Visibility(
                  visible: isCheckout,
                  child: Expanded(
